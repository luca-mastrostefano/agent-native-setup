# ai-project-setup — Agent Contract

A wizard that scaffolds an AI-native project setup into a new repo.

This file is the **single source of truth** for both human and AI contributors.
...
## How this project stays AI-native
...
- **Feedback loops** — agents in `.claude/agents/`, tests,
  and reviews close the loop so quality compounds. After changing a workflow in
