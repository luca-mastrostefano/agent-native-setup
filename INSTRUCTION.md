...
The standard operating principles for this repo — and the canonical version the wizard ships
into every project it scaffolds. [`AGENTS.md`](./AGENTS.md) is the project-specific map and
points here. For project-specific rules, edit `AGENTS.md` or add a nested contract, not this
file.
